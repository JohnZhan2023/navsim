...
class ModelArguments:
    ...
    diffusion_backbone: Optional[str] = field(
        default='DDPM', metadata={"help": "choose from [DDPM, DiT, MM-DiT]"}
    )
    ...
    debug_scenario_encoding: Optional[bool] = field(
        default=False, metadata={"help": "Whether to use the ScenarioEncoder."}
    )
    debug_scene_level_prediction: Optional[bool] = field(
        default=False,
    )
    debug_scenario_decoding: Optional[bool] = field(
        default=False,
    )
