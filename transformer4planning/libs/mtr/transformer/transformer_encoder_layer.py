...
from transformer4planning.libs.mtr.transformer.multi_head_attention_local import MultiheadAttentionLocal
from transformer4planning.libs.mtr.transformer.multi_head_attention import MultiheadAttention
